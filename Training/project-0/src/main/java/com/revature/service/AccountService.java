...
public class AccountService {
    ...
    public Account updateAccount(String id, String client_id, Account a) {
        try {
    ...
    private void validateAccountInformation(Account a) {
        ...
        else if (a.getType().equals("savings")){
            a.setType("Savings");
        }
        else{
            throw new IllegalArgumentException("Account name must be Checking or Savings. Account name input was " + a.getType());
        }
